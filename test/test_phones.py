...
def tests_phones_on_home_page(app):
    ...
    print(contact_from_home_page.lastname)
    print(contact_from_home_page.firstname)
    ...
    print(contact_from_edit_page.lastname)
    print(contact_from_edit_page.firstname)
    print(contact_from_edit_page.address)
