...
class GroupModel(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True, name='group_id')
    name = Column(String, nullable=True, name='group_name')
    header = Column(String, nullable=True, name='group_header')
    footer = Column(String, nullable=True, name='group_footer')
...
class SQLAlchemyFixture:
    ...
    def get_contacts_in_group(self, group):
        session = self.get_session()
        orm_group = session.query(GroupModel).filter(GroupModel.id == group.id).first()
